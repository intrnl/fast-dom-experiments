export function template (fragment) {
...
export function removeBetween (ref1, ref2) {
	removeAll(getBetween(ref1, ref2));
}

export function getBetween (ref1, ref2) {
	let nodes = [];
	let node = ref1;
...
export function toNodeArray (node) {
